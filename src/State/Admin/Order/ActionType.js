...
export const DELIEVERED_ORDER_REQUEST = 'DELIEVERED_ORDER_REQUEST';
export const DELIEVERED_ORDER_SUCCESS = 'DELIEVERED_ORDER_SUCCESS';
export const DELIEVERED_ORDER_FAILURE = 'DELIEVERED_ORDER_FAILURE';
