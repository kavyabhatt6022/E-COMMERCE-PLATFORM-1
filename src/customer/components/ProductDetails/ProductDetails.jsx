  ...
  return (
    <div className="bg-white lg:px-20">
      <div className="pt-6">
            ...
            <Grid item xs={5}>
              ...
              <Box className="mt-5 space-y-3">
                ...
                <Grid container  alignItems="center" gap={2}>
                  ...
                  <Grid item xs={7}>
                    <LinearProgress sx={{bgcolor:"#d0d0d0", borderRadius:4, height:7, '& .MuiLinearProgress-bar': { bgcolor: '#cddc39' 
                ...
                <Grid container  alignItems="center" gap={2}>
                  ...
                  <Grid item xs={7}>
                    <LinearProgress sx={{bgcolor:"#d0d0d0", borderRadius:4, height:7, '& .MuiLinearProgress-bar': { bgcolor: '#ffeb3b' 
        ...
        <div className="py-5 flex flex-wrap  space-y-5">
