            ...
            {[1, 1, 1, 1, 1, 1, 1].map((item)=><Grid item container className='shadow-xl rounded-md p-5 border' sx={{alignItems:"center", justifyContent:"space-between"}}>
                ...
                <Grid item xs={6}>
                    ...
                    <div className='flex items-center space-x-4'>
                        ...
                        <div className='space-y-2 ml-5'>
                            <p className='font-semibold'>Denim Blue Denim Men's Jeans</p>
                            <p className='space-x-5 opacity-50 text-xs'><span>Color: Denim Blue</span> <span>Size: M</span></p>
                            <p>Seller:Linaria</p>
                            <p>₹1099</p>
                        </div>
                    </div>
                ...
                <Grid item>
                    ...
                    <Box sx={{color:deepPurple[500]}}>
                        ...
                        <StarPurple500Icon sx={{fontSize:"2rem"}} className='px-2 text-5xl'/>
